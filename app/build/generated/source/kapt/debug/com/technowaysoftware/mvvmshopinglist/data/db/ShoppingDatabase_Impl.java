  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `shopping_items` (`item_id` INTEGER PRIMARY KEY AUTOINCREMENT, `item_name` TEXT NOT NULL, `item_amount` INTEGER NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'cd9faa3a85f8afb20efd534603d8a64e')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsShoppingItems.put("item_id", new TableInfo.Column("item_id", "INTEGER", false, 1, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoShoppingItems.equals(_existingShoppingItems)) {
          return new RoomOpenHelper.ValidationResult(false, "shopping_items(com.technowaysoftware.mvvmshopinglist.data.db.entities.ShoppingItem).\n"
                  + " Expected:\n" + _infoShoppingItems + "\n"
                  + " Found:\n" + _existingShoppingItems);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "cd9faa3a85f8afb20efd534603d8a64e", "b1675f3de6643ef7021552e08096fe65");
